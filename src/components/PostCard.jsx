...
const PostCard = ({ title, description, topic, postid, username }) => {
  ...
  return (
    <div
      ...
      className="w-[48%] sm:full  2xl:w-[31.8%] mx-2 my-2 rounded-md  flex flex-col bg-[#1C1C1C]  justify-between border-[0.2px] border-[#242424] px-5 py-5 gap-4 cursor-pointer hover:border-[#282828] "
    >
      <span className="text-sm font-semibold text-[#aeaeae] ">{topic}</span>
      <span className="text-2xl font-semibold text-[#F6F6F6] break-words">{title}</span>
