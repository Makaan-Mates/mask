    ...
    <div className=" h-[100vh] flex justify-center items-center ">
      <div className=" bg-[#f4f4f4] p-8 2xs:w-[90%] xs:w-[90%] md:w-3/4 sm:w-2/3 2xl:w-[28%] lg:w-2/6 h-auto rounded shadow-md mt-10  text-[#1c1c1c]">
        ...
        <div className="my-6">
          ...
          <input
            className="w-[94%] border rounded px-3 py-2 focus:outline-none focus:border-[#1c1c1c] "
            type="email"
            id="email"
            ref={email}
        ...
        <div className="my-6">
          <label className="block mb-1" htmlFor="password">
            ...
            <div className="flex items-center  ">
              ...
              />
              {showPassword ? (
                <FaRegEyeSlash onClick={handleShowPassword} className="ml-2" />
              ) : (
                <FaRegEye onClick={handleShowPassword} className="ml-2" />
              )}
            </div>
          </label>
        </div>
...
//                   />
//                 ) : (
//                   <FaRegEye onClick={handleShowPassword} className="ml-1" />
//                 )}
//               </div>
//             </label>
//           </div>
