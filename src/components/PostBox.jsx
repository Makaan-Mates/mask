...
const PostBox = () => {
  ...
  return (
    <div className="w-4/5 px-5 py-8  bg-zinc-800 ">
      ...
      <div className="content-box w-full 2xl:w-2/3 flex flex-col gap-6 bg-zinc-800 justify-between border-[0.2px] border-zinc-700 px-5 py-10  text-zinc-200 rounded-md ">
