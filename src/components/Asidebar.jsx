const Asidebar = () => {
  return (
    <div className="w-1/5 px-5 py-10 bg-inherit border-r-[1px] border-zinc-900 min-h-screen text-zinc-100">
        <div className="text-l px-2 py-1 text-center font-semibold border-2 border-red-500 hover:border-red-700 text-zinc-100 rounded-md cursor-pointer">WRITE A POST
        </div>
