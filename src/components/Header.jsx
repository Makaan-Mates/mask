  ...
  return (
    <div className="bg-zinc-800 z-20 sticky top-0 h-[12vh] text-zinc-200 py-4 px-6  flex items-center justify-between  border-b-[1px] border-zinc-900">
      <div className="flex items-center justify-center space-x-4 gap-5">
        <div onClick={handleNavigateHome} className="text-4xl cursor-pointer  font-bold transition-transform transform hover:scale-105">mask</div>
        <div onClick={handleNavigateHome} className="text-l cursor-pointer px-2 py-1 font-semibold hover:bg-zinc-700 rounded-md">Home </div>
